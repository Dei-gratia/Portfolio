...
class NestedModelAdmin(InlineInstancesMixin, admin.ModelAdmin):
    ...
    class Media:
        ...
        js = ('admin/js/inlines-nested%s.js' %
    ...
    def add_nested_inline_formsets(self, request, inline, formset, depth=0):
        ...
        for form in formset.forms:
            ...
            for nested_inline in inline.get_inline_instances(request):
                InlineFormSet = nested_inline.get_formset(
        ...
        for form in formset.forms:
            ...
            for nested_inline, nested_formset in zip(inline.get_inline_instances(request), form.nested_formsets):
                if form.instance.pk:
                    ...
                    instance = None
                fieldsets = list(
                    nested_inline.get_fieldsets(request, instance))
                readonly = list(
                    nested_inline.get_readonly_fields(request, instance))
                prepopulated = dict(
                    nested_inline.get_prepopulated_fields(request, instance))
                ...
                if nested_inline.inlines:
                    media = get_media(self.wrap_nested_inline_formsets(
